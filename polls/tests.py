...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_recent_question(self):
        """
        was_published_recently() returns True for questions made within the last day.
        """
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        """
        Questions with a pub_date in the future aren'' displayed on the index page.
        """
...
def create_question(question_text, days):
    ...
    of `days` offset to now(negative for questions published
